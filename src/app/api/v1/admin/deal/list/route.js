  ...
  if (verified.success) {
    if (id) {
      ...
      if (checkId) {
        ...
        _search["$and"] = [
          {
            $and: [{ n_status: 1 }, { n_published: 1 }, { lead_id: id },{live_status: "deal"}],
          },
        ];
    ...
    if (name) {
      ...
      if (checkName) {
        ...
        _search["$and"] = [
          {
            $and: [{ n_status: 1 }, { n_published: 1 }, { lead_slug_name: name },{live_status: "deal"}],
          },
        ];
      ...
      _search["$and"] = [
        {
          $and: [{ n_status: 1 }, { n_published: 1 }, {live_status: "deal"}],
        },
      ];
