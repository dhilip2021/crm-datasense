...
export async function POST(request) {
  ...
  try {
    ...
    if (currentRole?.c_role_priority !== 1) {
      ...
      console.log(userRoleId,"<<< role iddd")

      if(userRoleId === "27f01165688z" || userRoleId === "16f01165898b"){
        const updatedAllowedIds = [...allowedRoleIds, userRoleId]
      ...
      if (updatedAllowedIds.length > 0) {
        ...
        _search.c_role_id = []
         ...
         const updatedAllowedIds = [...allowedRoleIds]
