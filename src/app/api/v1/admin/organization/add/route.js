...
export async function POST(request) {
  const { organization_name,organization_logo,organization_address,organization_emp_count,organization_currency, companyType, Id, n_status, c_version } = await request.json();
