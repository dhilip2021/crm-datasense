...
import OpportunityReasonsManager from './OpportunityReasonsManager'
    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Breadcrumbs aria-label='breadcrumb'>
          ...
          <Typography sx={{ color: 'text.primary' }}>Reason Master</Typography>
        </Breadcrumbs>
      </Grid>
...
export default ReasonMasterPage
