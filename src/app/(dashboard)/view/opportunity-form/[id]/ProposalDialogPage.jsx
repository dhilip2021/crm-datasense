...
const ProposalDialogPage = ({ open, onClose, leadData }) => {
  ...
  const handleSend = () => {
    console.log('Send quotation to customer', { items, notes, uploadedFiles })
  }
  ...
  doc.text(`${leadData.values['Street']}, ${leadData.values['City']}, ${leadData.values['State']} - ${leadData.values['Pincode']}, ${leadData.values['Country']}`, margin, y + lineHeight * 3);
  ...
  doc.text('We look forward to doing business with you. Please feel free to contact us for any clarifications.', margin, closingY);
