...
const CustomerTemplateSchema = new mongoose.Schema(
  {
...
export default mongoose.models.CustomerTemplate || mongoose.model('CustomerTemplate', CustomerTemplateSchema)
