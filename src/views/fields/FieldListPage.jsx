...
function SortableCard({ data, index, handleAction, handleDelete, editFlag }) {
...
export default function FieldListPage({ fields, setFields,fieldDataList, editFlag, handleDelete, handleAction, handleDragEnd, sensors }) {
