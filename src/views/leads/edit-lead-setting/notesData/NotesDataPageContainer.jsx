...
import { createLead, getParticularLeadListApi } from '@/apiFunctions/ApiAction'

import LoaderGif from '@assets/gif/loader.gif'
import NotesDataPopup from './NotesDataPopup'
...
const NotesDataPageContainer = () => {
  ...
  const [selectedItem, setSelectedItem] = React.useState(null) // <- ADD this
...
export default NotesDataPageContainer
