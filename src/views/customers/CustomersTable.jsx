                      ...
                      <TableRow key={i}>
                        ...
                        <TableCell>
                          <Chip
                            ...
                            color={
                              row.values['Status'] === 'New / Attempted Contact'
                                ? 'primary'
                                : row.values['Status'] === 'Contacted / Qualification'
                                  ? 'info'
                                  : row.values['Status'] === 'Demo / Proposal Stage'
                                    ? 'success'
                                    : row.values['Status'] === 'Negotiation / Ready to Close'
                                      ? 'secondary'
