              ...
              <Grid container spacing={2}>
                <Grid item xs={12} mt={2} mb={2}>
                  <TextField
                    ...
                    type='text'
                    size='small'
                    value={inputs?.uom_code}
                    onChange={(e)=> handleChange(e)}
                    onBlur={handleBlur}
                    error={Boolean(errors?.uom_code)}
                    helperText={errors?.uom_code && 'Please enter UOM Code'}
                    sx={{
                 ...
                 <Grid item xs={12} mt={2} mb={2}>
                  <TextField
                    autoComplete='off'
                    name='uom_label'
                    placeholder='Ex: Pieces, Kilograms...'
                    fullWidth
                    id='outlined-basic'
                    label='UOM Label'
                    variant='outlined'
                    type='text'
                    size='small'
                    value={inputs?.uom_label}
                    onChange={(e)=> handleChange(e)}
                    onBlur={handleBlur}
                    error={Boolean(errors?.uom_label)}
                    helperText={errors?.uom_label && 'Please enter UOM Label'}
                    sx={{
                      '.MuiFormHelperText-root': { ml: 0 }
                    }}
                    inputProps={{
